...
type
  TOnDefineParametros = procedure (const coSQLDataSet: TSQLDataSet) of object;
  ...
  private
    ...
    FDBGrid            : TDBGrid;
    FOnDefineParametros: TOnDefineParametros;
  ...
  public
    ...
    property OnDefineParametros: TOnDefineParametros read FOnDefineParametros write FOnDefineParametros;
  end;
...
begin
  ...
  if Assigned(FOnDefineParametros) then
  begin
    FOnDefineParametros(dmEntra21.SQLSelect);
  end;
